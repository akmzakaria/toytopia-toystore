...
const StatsSection = () => {
  ...
  return (
    <div data-aos="zoom-in">
      <div className="text-center p-10 md:p-20 bg-black/10 text-gray-800 rounded-2xl transition transform ease-in-out duration-300 hover:shadow-xl hover:scale-105">
