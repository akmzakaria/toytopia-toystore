  ...
  return (
    <div data-aos="zoom-in">
      <div className="flex justify-center px-2 my-15 ">
        <div className="card border w-full max-w-sm md:max-w-lg lg:max-w-xl shadow-lg rounded-2xl pt-5 transition transform ease-in-out duration-300 hover:shadow-2xl hover:scale-105">
